...
//print(falcon.weapon)
print("falcon not able to get fighter class properties because they are not related to each other . they have only common parent class but they not inherited each other.")
