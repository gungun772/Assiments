 ...
 */
var daysInMonth:[String:Int]=["January":31,
                              "February":28,
                              "March":31]
print(daysInMonth)
...
var colorsArray=["pink","violet","black"]
let newDic:[String:[String]]=["Shapes":shapesArray,
                              "Colors":colorsArray]
print(newDic)
...
if let ele=newDic["Colors"], let color=ele.last{
    print(color)
}
