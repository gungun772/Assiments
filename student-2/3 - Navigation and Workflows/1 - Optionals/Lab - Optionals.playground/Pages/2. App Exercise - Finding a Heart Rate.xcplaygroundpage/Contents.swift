...
if let heartRateValue=heartRate{
    var hrAverage:Int=(oldHR1+oldHR1+oldHR3+oldHR4+heartRateValue)/5
    print(hrAverage)
}else{
    var hrAverage:Int=(oldHR1+oldHR1+oldHR3+oldHR4)/4
    print(hrAverage)
}
//var hrAverage:Int=(oldHR1+oldHR1+oldHR3+oldHR4)/heartRate!
