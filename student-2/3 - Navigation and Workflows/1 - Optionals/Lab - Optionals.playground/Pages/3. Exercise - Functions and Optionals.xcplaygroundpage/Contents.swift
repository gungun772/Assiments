...
func checkAge(userAgeGiven:String)->Int?{
    var convertedAge:Int? = Int(userAgeGiven)
    return convertedAge
}
if let age=checkAge(userAgeGiven: userInputAge){
    if age > 18 {
        print("Welcome!")
    }else if age < 18 {
        print("Sorry, but you aren't old enough to use our app.")
    }else{
        print("you are 18 now")
    }
}else{
    print("Sorry, something went wrong. Can you please re-enter your age?")
}
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
print(checkAge(userAgeGiven: userInputAge))
...
func makingPurchases(name:String)->Double?{
...
print(makingPurchases(name:"Juice")!)
print(makingPurchases(name:"Apple")!)
/*:
