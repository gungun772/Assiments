...
print(userAge)
// it giving a nil value because we are trying to convert a actual string value into interger so it giving a nil value.
/*:
...
if let userAgeValue=userAge{
    print(userAgeValue)
}else{
    print("it has a nil value")
}
