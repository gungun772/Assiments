...
//print(falcon.weapon)
print("falcon.weapon doesn't work because weapon is a variable property of the Fighter class, which is a parent class of Destroyer which doesn't have its own weapon property")
