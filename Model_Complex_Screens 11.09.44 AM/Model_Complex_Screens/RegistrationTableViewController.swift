...
//         self.navigationItem.rightBarButtonItem = self.editButtonItem
    ...
    @IBAction func unwindFromRegistration(unwindSegue : UIStoryboardSegue){
            ...
            if let selectedIndex = addRegistrationViewController.selectedRowIndex {
                registrations[selectedIndex] = registration
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EditRegistration",
           ...
           let addVC = segue.destination as? AddRegistrationTableViewController{
            addVC.existingRegistration = registrations[index.row]
            addVC.selectedRowIndex = index.row
        }
    }
