...
let rec1=Rectangle(width: 23, height: 45)
print(rec1.area())
/*:
...
struct Height {
    ...
    mutating func heightInInchesChange(heightInInches:Double){
        self.heightInInches=heightInInches
    }
    mutating func heightInCentimeterChange(heightInCentimeter:Double){
        self.heightInCentimeters=heightInCentimeter
    }
    func display(){
        print("height in inches:\(heightInInches) and in centimeter: \(heightInCentimeters)")
    }
}
var height1=Height(heightInCentimeters: 34)
height1.display()
height1.heightInInchesChange(heightInInches: 12.6)
height1.display()
