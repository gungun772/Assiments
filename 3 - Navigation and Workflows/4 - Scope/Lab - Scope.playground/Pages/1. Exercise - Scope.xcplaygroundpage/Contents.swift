...
//print("The value of foo is \(foo)")
print("Because variable foo is only accessible inside the for loop as it is declared inside it which makes it a local variable")
...
print("Because x is declared outside for loop which makes it global variable")
